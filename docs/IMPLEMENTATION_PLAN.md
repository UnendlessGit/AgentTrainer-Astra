...
| RL workflows | Fresh-policy and BC-initialized runs; manual and validated automatic reset; live target continuity | Native collector/learner process handoff, immutable audited rollouts, actor cursor resumption, reset authoring/runner/protected driver and bounded episode-evidence bridge implemented with focused checks. Persistent desktop orchestration, manual feedback input, installed reset/control workflows and scheduling qualification remain open |
...
| GitHub | New public UnendlessGit/AgentTrainer-Astra history, completed source pushed to main | Independent history and restored-machine actor/control/collector milestone49d3947 pushed; current increment and completed source/release pending |
